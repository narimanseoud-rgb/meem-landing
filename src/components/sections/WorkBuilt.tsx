    ...
    <section ref={ref} className="relative py-32 bg-secondary overflow-hidden">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          >
            <span className="text-primary-foreground">What Work We’ve </span>
        ...
        <div className="mb-16">
          ...
          >
            <div className="relative w-full max-w-4xl bg-foreground rounded-2xl p-2 shadow-2xl">
              ...
              >
                <source src="https://firebasestorage.googleapis.com/v0/b/bump-pozhf5.firebasestorage.app/o/meem%20landing%20page%2FWhatsApp%20Video%202026-04-18%20at%2015.35.30%20(1).mp4?alt=media&token=92cb2415-73ac-47fe-bb1e-0d4d74715144" type="video/mp4" />
              </video>
            </div>
          </motion.div>
        </div>
